                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="artDropdown">
                            ...
                            <a class="dropdown-item" href="<?php echo base_url('buyer_dash/Sold_art'); ?>">Sold</a>
                            <a class="dropdown-item" href="<?php echo base_url('buyer_dash/Expired_art'); ?>">Expired</a>
                        </div>
                    </li>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo base_url('buyer_dash/My_colls'); ?>" class="nav-link"><b>My Collection</b></a>
